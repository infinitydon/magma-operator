...
func renderNativeManifest(manifest string, release nativeRelease) string {
	replacements := map[string]string{
		...
		"domain-placeholder.local":     valueOrDefault(release.Values, "global.domainName", valueOrDefault(release.Values, "config.domainName", "magma.local")),
		"controller-placeholder.local": valueOrDefault(release.Values, "orc8r.nms.controllerHostname", "controller.magma.local"),
